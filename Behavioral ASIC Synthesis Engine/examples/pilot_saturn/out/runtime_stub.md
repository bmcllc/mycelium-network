2026-07-19T02:42:11.410140Z  INFO ≠ Wine / ≠ Win32 completo / ≠ runtime Saturn·DC: `static_recomp_complete: false` · `win32_abi_complete: false` · `runs_any_pe: false` · `runs_on_saturn: false` · `runs_on_dreamcast: false`
## Runtime (stub)
